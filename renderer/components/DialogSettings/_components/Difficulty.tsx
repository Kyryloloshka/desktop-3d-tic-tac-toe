...
export function Difficulty({
  ...
  return (
    <>
      ...
      <Slider.Root
        onMouseEnter={() => setOpenTipSlider(true)}
        onMouseLeave={() => setOpenTipSlider(false)}
        disabled={!selectedIsPlayWithBot}
        className="SliderRoot col-span-3"
        defaultValue={[(selectedDifficulty * 100) / 3]}
